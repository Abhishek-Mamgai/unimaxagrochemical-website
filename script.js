    ...
    function renderSummary() {
        ...
        if (placeOrderBtn) {
            placeOrderBtn.addEventListener("click", () => {
                ...
                // Build a simple text summary of the order for email
                ...
                const emailSubject = encodeURIComponent(`New order from UNIMAXAGRO website - ${order.id}`);
                ...
                // Open the user's email client with the order details addressed to your inbox
                if (CONTACT_EMAIL) {
